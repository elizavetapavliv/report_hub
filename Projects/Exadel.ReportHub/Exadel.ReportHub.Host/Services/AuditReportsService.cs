...
public class AuditReportsService(ISender sender) : BaseService
{
    ...
    [SwaggerResponse(StatusCodes.Status403Forbidden, "this User doesnt have permission to access Audit Reports")]
    ...
    [SwaggerResponse(StatusCodes.Status401Unauthorized, "Authentication is required to access this endpoint")]
    [SwaggerResponse(StatusCodes.Status403Forbidden, "this User doesnt have permission to access a Audit Report")]
