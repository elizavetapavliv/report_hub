...
public class CustomersService(ISender sender) : BaseService
{
    ...
    [SwaggerResponse(StatusCodes.Status201Created, "Customer created successfully", typeof(ActionResult<CustomerDTO>))]
    ...
    [SwaggerResponse(StatusCodes.Status200OK, "Customers retrieved successfully", typeof(ActionResult<IList<CustomerDTO>>))]
    [SwaggerResponse(StatusCodes.Status401Unauthorized, "Authentication is required")]
    ...
    [SwaggerResponse(StatusCodes.Status200OK, "Customer retrieved successfully", typeof(ActionResult<CustomerDTO>))]
    [SwaggerResponse(StatusCodes.Status401Unauthorized, "Authentication is required")]
