...
public class InvoiceManagerTests : BaseTestFixture
{
    ...
    public async Task GenerateInvoiceAsync_ReturnsInvoice()
    {
        ...
        Assert.That(result.BankAccountNumber, Is.EqualTo(client.BankAccountNumber));
    ...
    public async Task GenerateInvoicesAsync_ReturnsInvoices()
    {
        ...
        Assert.That(result[0].BankAccountNumber, Is.EqualTo(client.BankAccountNumber));
        ...
        Assert.That(result[1].BankAccountNumber, Is.EqualTo(client.BankAccountNumber));
