...
public class GetInvoicesRevenueHandler(IInvoiceRepository invoiceRepository, IMapper mapper) : IRequestHandler<GetInvoicesRevenueRequest, ErrorOr<TotalInvoicesRevenueDTO>>
{
    ...
    {
        var revenueResult = await invoiceRepository.GetTotalAmountByDateRangeAsync(request.InvoiceRevenueFilterDto.ClientId,
